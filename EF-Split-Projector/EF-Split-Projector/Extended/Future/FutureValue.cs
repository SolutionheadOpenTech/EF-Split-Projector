...
namespace EF_Split_Projector.Extended.Future
{
    ...
    public class FutureValue<T> : FutureQueryBase<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:EF_Split_Projector.Extended.Future.FutureValue`1"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T:EF_Split_Projector.Extended.Future.FutureValue`1" /> to T.
        /// </summary>
